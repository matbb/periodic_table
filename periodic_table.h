...
namespace constants {
const double atomic_mass_constant = 1.6605387820000001282e-27;
const double avogadro_number = 6.0221417899999998928e+23;
const double electron_mass = 0.00054857799094600002369;
const double electron_radius = 2.8179402894000000271e-15;
const double electron_volt = 1.6021764870000000295e-19;
const double neutron_mass = 1.0086649159700000755;
const double plancks_constant = 4.135667330000000095e-15;
}; // namespace constants
